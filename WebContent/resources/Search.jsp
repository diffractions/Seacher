	...
	<table>
		<c:forEach var="paper" items="${find_papers}">
			<tr>
				...
				<td><%=((Paper) pageContext.getAttribute("paper")).getText().replaceAll(request.getParameter("search"),
								"<font style=\"color:red; " + "text-decoration: underline; "
										+ "text-decoration-style:dotted; " + "text-decoration-color: red;\" >"
										+ request.getParameter("search") + "</font>")%></td>
			</tr>
		</c:forEach>
